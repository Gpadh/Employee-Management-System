...
import static ems.ListAllEmployees.hashTable;
...
public class SearchEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchTableTitle.setBorder(new javax.swing.border.SoftBevelBorder(0));
            ...
            for (int i = 0; i < hashTable.buckets.length; i++){         
                ...
                for (int j = 0; j < hashTable.buckets[i].size(); j++){
                    ...
                    if (empNumber == hashTable.buckets[i].get(j).getEmployeeNumber()){
                        ...
                        else if(this.hashTable.buckets[i].get(j) instanceof FTEmployee){  
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchEmployee(hashTable).setVisible(true);
            }
        });
    }
